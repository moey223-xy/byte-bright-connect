...
const steps = [
  {
    icon: MessageSquare,
    title: "Consult",
    description: "We listen to your needs and assess your current IT infrastructure."
  },
  {
    icon: FileText,
    title: "Plan",
    description: "We create a customized strategy tailored to your business goals."
  },
  {
    icon: Rocket,
    title: "Deploy",
  ...
  },
  {
    icon: Headphones,
    title: "Support",
    description: "We provide ongoing support and monitoring to ensure peak performance."
  }
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-1 bg-gray-200">
            <div className="h-full bg-[#2978F2] w-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                {/* Timeline Dot */}
                <div className="hidden lg:block absolute top-20 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-[#2978F2] rounded-full border-4 border-white shadow-lg z-10"></div>
                
                <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 bg-white rounded-2xl group pt-8">
