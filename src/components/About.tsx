        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6 text-lg text-gray-600">
              ...
              <p>
                Today, we're proud to be the trusted IT partner for over 500 small businesses, helping them leverage technology to grow, compete, and thrive in the digital age.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-8 mt-12">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#2978F2]">2018</div>
                <div className="text-gray-600">Founded</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#2978F2]">500+</div>
          ...
          <div className="lg:pl-8">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
              ...
              <Card className="rounded-2xl overflow-hidden shadow-lg">
                <CardContent className="p-0">
                  <img
                    src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=200&h=200&fit=crop&crop=face"
                    alt="Team Member"
                    className="w-full h-24 object-cover"
                  />
                </CardContent>
